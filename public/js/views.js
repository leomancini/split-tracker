  ...
  if(members.length >= 2){
    ...
    members.forEach(function(m, idx){
      ...
      h += '<div class="exp-participant-row" style="display:flex;align-items:center;gap:0.625rem;padding:0.75rem;margin:0'+borderStyle+'">'
        ...
        + '<span class="exp-uneven-prefix" style="display:none;font-size:0.9375rem;color:var(--gray-500);margin-right:-0.375rem">$</span>'
        ...
        + '<span class="exp-pct-sign" style="display:none;font-size:0.9375rem;color:var(--gray-500);margin-left:-0.375rem">%</span>'
        + '</div>';
    });
    h += '</div>'
      + '</div>';
