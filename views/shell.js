    ...
    function groupDetailView(detail, alert){
      ...
      if(mySettlements.length){
        ...
        settlements.forEach(function(s){
          ...
          h += '<div class="settlement-row" style="display:flex;justify-content:space-between;align-items:center;padding:0.5rem 0;min-height:2.75rem">'
        ...
        otherSettlements.forEach(function(s){
          h += '<div class="settlement-row" style="display:flex;justify-content:space-between;align-items:center;padding:0.5rem 0;min-height:2.75rem;color:var(--gray-400)">'
            + '<span class="settlement-text" style="font-size:1rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;min-width:0">'
